...
const Full = () => {
  ...
  return (
   ...
   <View style={{ position:'absolute',gap:15, bottom:'5%',left:'10%',flexDirection:'grid',alignItems:'center'}}>
      <TouchableOpacity onPress={() => router.push('../signup/Mail')}  style={{backgroundColor: '#DFDFDF', width:wp(80), flexDirection:'row', justifyContent:'center', alignItems:'center',padding:10,borderRadius:5,   }}>
      <Text style={{fontSize: 16,  }}>Next</Text>
      </TouchableOpacity>
      <View style={{ flexDirection:'row', gap:5}}>
          <Text style={{fontSize:15, color:'white', }}>Have an account?</Text>
          <TouchableOpacity onPress={() => router.push('../Login/Nam')} >
              <Text style={{fontSize:15, color:'white', fontWeight:'bold'}}>Log In</Text>
          </TouchableOpacity>
      </View>
     </View>
    </View>
